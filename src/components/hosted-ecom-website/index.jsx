    ...
    return (
        <div className={`${style.ecomPlatform} grid justify-between`}>
            <div className={`${style.ecomCard}`}>
                <a href='https://www.capillarytech.com/products/anywhere-commerce-plus/anywhere-commerce/' className={`${style.cardLink} grid justify-between align-center`}>
            ...
            <div className={`${style.ecomCard}`}>
                <a href='https://www.zepo.in/blog/tag/paytm-payment-gateway/' className={`${style.cardLink} grid justify-between align-center`}>
                    <span className={`grid justify-between align-center`}>
            ...
            <div className={`${style.ecomCard}`}>
                <a href='https://www.kartrocket.com/' className={`${style.cardLink} grid justify-between align-center`}>
                    <span className={`grid justify-between align-center`}>
            ...
            <div className={`${style.ecomCard}`}>
                <a href='https://ecomchain.com/' className={`${style.cardLink} grid justify-between align-center`}>
                    <span className={`grid justify-between align-center`}>
